            ...
            <div className="container mx-auto">
                <div className="services-content py-8 px-4 md:py-[80px] md:px-[60px]">
                    <div className="max-w-[600px] mx-auto mb-8">
                        <h2 className="text-3xl md:text-4xl lg:text-[44px] leading-[108%] text-white font-sans-semibold text-center mb-4">
                            What I do ?
                        </h2>
                        <p className="text-base md:text-lg lg:text-[28px] leading-[120%] text-grey font-sans-medium text-center">
                    ...
                    <div className="flex items-center justify-center gap-12">
                        <div className="relative max-w-6xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 relative z-10">
                                ...
                                {/* Step 1 */}
                                <div className="group relative bg-gray-300 backdrop-blur-md border border-white rounded-2xl p-4 sm:p-8 text-center hover:scale-105 transition-all duration-500 flex flex-col justify-center items-center min-h-[340px] sm:min-h-[400px]">
                                    {/* Step Number */}
                                    <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                                        <div className="w-12 h-12 bg-gray-300 border border-white  rounded-full flex items-center justify-center text-primary font-bold text-lg shadow-lg">
                                            01
                                        </div>
                                    </div>
                                ...
                                {/* Step 2 */}
                                <div className="group relative bg-gray-300 backdrop-blur-md border border-white rounded-2xl p-4 sm:p-8 text-center hover:scale-105 transition-all duration-500 flex flex-col justify-center items-center min-h-[400px]">
                                    {/* Step Number */}
                                    <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                                        <div className="w-12 h-12 bg-gray-300 border border-white  rounded-full flex items-center justify-center text-primary font-bold text-lg shadow-lg">
                                            02
